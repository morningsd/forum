            ...
            <ul class="list-group list-group-flush">
                <c:forEach var="topic" items="${topicList}">
                    <div class="row d-flex justify-content-center mb-3">
                        <div class="col-md-8">
                            <li class="list-group-item">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1"><i class="bi bi-book">${topic.name}</i>
                                    </h5>
                                </div>
                                ...
                                <p class="mb-1 w-100 justify-content-between d-flex">
                                    <i class="bi bi-file-earmark-person"> ${topic.createdBy}</i>&nbsp;
                                    <i class="bi bi-calendar-date"> ${topic.createdAt}</i>
                                </p>
                            </li>
                        </div>
                        <div class="col-xs-2 mr-1">
                            <form class="" action="/jsp/editTopic" method="get">
                        ...
                        <div class="col-xs-2">
                            <form class="" action="/jsp/deleteTopic" method="post">
                                <input type="hidden" name="topic_id" value="${topic.id}">
