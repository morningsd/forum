                            ...
                            <div class="col-10">
                                <li class="list-group-item">
                                    <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <small><i class="bi bi-basket3">Quantity <fmt:message
                                                key="catalog_jsp.booklist.in_stock"/></i></small>
                                    </div>
                                    <p class="mb-1">
                                        <i class="bi bi-file-earmark-person">Author</i>&nbsp;
                                        <i class="bi bi-briefcase">Publisher</i>&nbsp;
                                        <i class="bi bi-calendar-date">PublishedDate</i>
                                    </p>
                                </li>
                            </div>
                            <div class="col-2">
